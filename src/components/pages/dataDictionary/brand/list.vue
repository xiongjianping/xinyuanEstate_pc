  ...
  <div class="mainContent" v-loading="loading" element-loading-text="拼命加载中">
    ...
    <div class="listCont">
      <el-table :data="data.list" border size="medium">
        <el-table-column align="center" type="index" label="项目名称" width="50"></el-table-column>
        <el-table-column align="center" prop="projectName" label="品牌名称"></el-table-column>
        <el-table-column align="center" prop="area" label="品牌编号"></el-table-column>
        ...
        <el-table-column align="center" prop="operationleader" label="经营方式"></el-table-column>
        <el-table-column align="center" prop="startTime" label="修改时间"></el-table-column>
        <el-table-column align="center" prop="phone" label="修改人"></el-table-column>
        <el-table-column align="center" prop="merchandiseName" label="状态">
          <template slot-scope="scope">
            <el-button disabled  size="small" type="success" v-if="scope.row.status === 'ENABLED'">签约</el-button>
            <el-button disabled  size="small" type="danger" v-if="scope.row.status === 'DISABLED'">停用</el-button>
          </template>
        </el-table-column>
