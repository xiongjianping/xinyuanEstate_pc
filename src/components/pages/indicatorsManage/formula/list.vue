  ...
  <div class="mainContent" v-loading="loading" element-loading-text="拼命加载中">
    ...
    <div class="listCont">
      <el-table :data="data.list" border size="medium">
        ...
        <el-table-column align="center" prop="projectName" label="结果"></el-table-column>
        <el-table-column align="center" prop="area" label="公式"></el-table-column>
        ...
        <el-table-column align="center" prop="projectleader" label="修改人"></el-table-column>
