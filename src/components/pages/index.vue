            ...
            <!--<div class="cont-top">-->
              ...
              <!--&lt;!&ndash;<div class="cent-btn-right">&ndash;&gt;-->
                <!--&lt;!&ndash;<ul>&ndash;&gt;-->
                  ...
                  <!--&lt;!&ndash;<li>10P客销度</li>&ndash;&gt;-->
                  <!--&lt;!&ndash;<li>10P适配值</li>&ndash;&gt;-->
                <!--&lt;!&ndash;</ul>&ndash;&gt;-->
              <!--&lt;!&ndash;</div>&ndash;&gt;-->
            <!--</div>-->
...
<script>
  ...
  mounted () {
    ...
    var option = {
      ...
      parallelAxis: [
        {
          dim: 0, name: '溢租率(%)',min:-100,max:100,color:'#ffff',
          axisLine:{
            lineStyle:{
              width:10,
              color: {
    ...
    .index-box{
      ...
      .left-box{
        ...
        .left-top{
          ...
          height:100px;
          margin-left: 5px;
          background-image: url("../../assets/images/l_t.png");
          background-size:100% 100px;
          .left-top-t1{
            width: 190px;
            height: 28px;
            margin-left: 7px;
            background: url("../../assets/images/l_t1.png");
            p{
              text-align: center;
              color: white;
              font-size: 16px;
        ...
        .left-cent{
          ...
          margin-top: 15px;
          margin-left: 5px;
          background: url("../../assets/images/l_t.png");
