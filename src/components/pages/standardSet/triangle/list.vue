  ...
  <div class="mainContent" v-loading="loading" element-loading-text="拼命加载中">
    ...
    <div class="listCont">
      <el-table :data="data.list" border size="medium">
        ...
        <el-table-column align="center" prop="operationleader" label="毛利率"></el-table-column>
        <el-table-column align="center" prop="phone" label="客单价"></el-table-column>
        <el-table-column align="center" prop="projectleader" label="溢租率"></el-table-column>
        <el-table-column align="center" prop="operationleader" label="客销度"></el-table-column>
        <el-table-column align="center" prop="phone" label="适配值"></el-table-column>
