  ...
  <div class="mainContent" v-loading="loading" element-loading-text="拼命加载中">
    ...
    <div class="listCont">
      <el-table :data="data.list" border size="medium">
        ...
        <el-table-column align="center" prop="startTime" label="良好"></el-table-column>
        <el-table-column align="center" prop="projectleader" label="提升"></el-table-column>
        <el-table-column align="center" prop="projectleader" label="合理"></el-table-column>
        <el-table-column align="center" prop="projectleader" label="亏损"></el-table-column>
